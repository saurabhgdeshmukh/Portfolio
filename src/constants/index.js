  ...
  const experiences = [
    {
      ...
      points: [
        ...
        "Built robust server-side logic and APIs, managed MySQL databases to ensure seamless data handling and integration.",
        "Collaborated with teams to align development with goals, ensuring smooth execution and effective communication.",
      ],
    },
